...
import is.galia.plugin.jdbc.test.JDBCCacheUtils;
...
class JDBCCacheTest extends BaseTest {
    ...
    public static void beforeClass() {
        new JDBCCache().onApplicationStart();
    }
    ...
    public void setUp() throws Exception {
        ...
        JDBCCacheUtils.dropCacheTables();
        JDBCCacheUtils.createCacheTables();
    ...
    @Test
    void getPluginName() {
        assertEquals(JDBCCache.class.getSimpleName(), instance.getPluginName());
    }
    ...
    void newVariantImageInputStreamConcurrently() throws Exception {
        ...
        new ConcurrentProducerConsumer(() -> {
            ...
            return null;
        }, JDBCCache.getMaxPoolSize() - 5).run();
    }
